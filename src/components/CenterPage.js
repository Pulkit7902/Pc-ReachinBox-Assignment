        ...
        <div className='flex items-center space-x-3'>
          ...
          <div className='relative'>
            <div
              ...
              className='dark:bg-[#1F1F1F] flex items-center text-black dark:text-white border bg-white dark:border-[#343A40] rounded-md py-2 px-3 text-sm cursor-pointer'
            >
              Move <SlArrowDown className='ml-2' />
            </div>
            {isOpen && (
              <div className='absolute left-0 mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-[#1F1F1F] dark:border-[#343A40] border border-gray-200 z-10'>
                <div className='py-1'>
                  <a
                    href='#'
